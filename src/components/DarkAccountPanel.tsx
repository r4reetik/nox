...
export const DarkAccountPanel = () => {
    ...
    const formatUSDC = (value: string) => {
        return parseFloat(formatUnits(BigInt(value), 18)).toLocaleString(
            "en-US",
            {
                ...
                <SheetContent className="glass-panel border-l-primary/30 w-[480px] sm:max-w-none flex flex-col">
                    <SheetHeader className="flex flex-row justify-between items-center">
                        <div>
                            ...
                            <SheetDescription>
                                Manage your private funds and notes within the
                                Dark Pool.
                            </SheetDescription>
                        </div>
                        <Button
                    ...
                    {!userClient ? (
                        <div className="flex-1 flex items-center justify-center text-center text-muted-foreground">
                            <p>
                                Switch to Private Mode to view your dark
                                account.
                            </p>
                        </div>
                    ) : isLoading ? (
                                ...
                                <div className="p-4 bg-card/20 rounded-lg">
                                    ...
                                    <p className="text-3xl font-mono text-primary">
                                        {metadata?.commitment_info
                                            ? formatUSDC(
                                                  metadata.commitment_info.value
                                              )
                                            : "0.00"}{" "}
                                        USDC
                                    </p>
                                ...
                                <div className="p-4 bg-card/20 rounded-lg space-y-2 text-sm">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-mono">
                                            {
                                                // @ts-ignore
                                                (metadata?.last_used_nullifier_nonce ??
                                                    "N/A") + 1
                                            }
                                        </span>
                                    </div>
