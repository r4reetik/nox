        ...
        try {
            if (type === "deposit") {
                ...
                if (isPrivateMode) {
                    if (source === "eoa") {
                        ...
                        const existingNullifier =
                            userClient!.getCurrentNullifier();
                ...
                if (isPrivateMode) {
                    ...
                    const signature =
                        await userClient!.secretWallet.signMessage(
                ...
                if (isPrivateMode && source === "darkPool" && userClient) {
                    const dpEvent = receipt.logs.find(
                        (l) =>
                            ...
                            l.topics[0] ===
                                ethers.id(
                                    "CommitmentInserted(bytes32,uint32,bytes32)"
                                )
                    ...
                    <div className="space-y-2">
                        ...
                        {isPrivateMode && source === "darkPool" && (
                            <p className="text-xs text-muted-foreground">
                                ...
                                {formatUnits(privateBalance, 18)} USDC
                            </p>
                        )}
                    </div>
