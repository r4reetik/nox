    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] flex items-center justify-center">
            <div className="glass-panel p-8 rounded-lg neon-border-primary w-full max-w-md text-center space-y-6">
                <h2 className="text-2xl font-bold ">Generating Secure Proof</h2>
                <p className="text-muted-foreground">
                    Your browser is performing complex cryptographic
                    calculations to protect your privacy. Please keep this
                    window open.
                </p>
